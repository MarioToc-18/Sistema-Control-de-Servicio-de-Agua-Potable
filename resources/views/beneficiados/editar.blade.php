    ...
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="body">
                ...
                <form role="form" method="POST" action="{{route('beneficiados.actualizar', $registro->id_beneficiado)}}" >
                   {{csrf_field()}} {{ method_field('PUT') }}
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label>DPI</label>
                                <input type="text" class="form-control" value="{{old('cui', $registro->cui)}}" name="cui" id="cui">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label>Primer Nombre</label>
                                <input type="text" class="form-control" value="{{old('nombre1', $registro->nombre1)}}" name="nombre1" id="nombre1">
                            </div>
                        </div>
                        <div class="col-md-4">
                             <div class="form-group">
                                <label>Segundo Nombre</label>
                                <input type="text" class="form-control" value="{{old('nombre2', $registro->nombre2)}}" name="nombre2" id="nombre2">
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                             <div class="form-group">
                                ...
                                <input type="text" class="form-control" value="{{old('apellido1', $registro->apellido1)}}" name="apellido1" id="apellido1">
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                             <div class="form-group">
                                ...
                                <input type="text" class="form-control" value="{{old('apellido2', $registro->apellido2)}}" name="apellido2" id="apellido2">
                            </div>
                        </div>
                    ...
                    <br>
                    <button type="submit" class="btn btn-success"><i class="fa fa-refresh"></i> Actualizar Beneficiado</button>
                </form>
